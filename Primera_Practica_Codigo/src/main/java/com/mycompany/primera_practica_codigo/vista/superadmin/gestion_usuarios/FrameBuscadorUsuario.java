 ...
 * @author Matul
 */
public class FrameBuscadorUsuario extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FrameBuscadorUsuario
     */
    public FrameBuscadorUsuario(JFrame frameAntFrame) {
        initComponents();
        cargarUsuarios();
        setLocationRelativeTo(null);
        this.frameAnterior = frameAntFrame;
    }

    private void cargarUsuarios() {
        // Elimiar eleemntos del JComboBox
        ...
        try {
            ...
            String mensaje = "Error al cargar usuarios: " + e.getMessage();
    ...
    private void initComponents() {
        ...
        jLabelBuscarEditarSucursal.setText("Seleccione el usuario que desea editar");
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonEditarActionPerformed
        Usuario usuarioSeleccionado = obtenerUsuarioDeLista();
        if (usuarioSeleccionado != null) {
            FrameEditorUsuario frameEditorUsuario = new FrameEditorUsuario(usuarioSeleccionado);
            frameEditorUsuario.setVisible(true);
            frameAnterior.dispose();
            this.dispose();
        } else {
            String mensaje = "No se pudo encontrar el usuario seleccionado.";
            MensajeErrorFrame mensajeErrorFrame = new MensajeErrorFrame(null, true, mensaje);
        }
    }// GEN-LAST:event_jButtonEditarActionPerformed

    private Usuario obtenerUsuarioDeLista() {
        String nombreUsuarioSeleccionado = (String) jComboBoxUsuarios.getSelectedItem();
        for (Usuario usuario : usuarios) {
            if (usuario.getNombreUsuario().equals(nombreUsuarioSeleccionado)) {
                return usuario;
            }
        }
        return null;
